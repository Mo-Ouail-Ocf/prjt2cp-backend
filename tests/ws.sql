...
insert into sessions (project_id, title, ideation_technique, start_time, session_status, round_time) values (1, 'first session', 'brain_wrting', '2024-04-02 13:17:35.374492+01', 'open', 5);
insert into project_user (project_id, user_id, role, invitation_status) values (1, 1, 'Admin', 'accepted');
...
insert into project_user (project_id, user_id, role, invitation_status) values (1, 2, 'user', 'accepted');
