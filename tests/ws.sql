...
insert into sessions (project_id, title, ideation_technique, start_time, session_status) values (2, 'first session', 'brain_wrting', '2024-04-02 13:17:35.374492+01', 'open');
insert into project_user (project_id, user_id, role, invitation_status) values (2, 1, 'Admin', 'accepted');
